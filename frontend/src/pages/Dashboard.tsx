        ...
        <section className="surface step-animate">
          ...
          {montroseConnected && (
            <div className="stack stack--tight" style={{ marginTop: '0.75rem', maxWidth: '32rem' }}>
              <label>
                Sälj (fondnamn)
                <input value={sellName} onChange={(e) => setSellName(e.target.value)} />
              </label>
              <label>
                Köp (fondnamn)
              ...
              <label>
                Belopp (SEK)
                <input type="number" min={1000} step={1000} value={amountSek} onChange={(e) => setAmountSek(Number(e.target.value))} />
              </label>
              <label>
          ...
          {montroseError && (
            <p className="error small" role="alert" style={{ marginTop: '0.75rem' }}>
              {montroseError}
            </p>
          )}
          {montroseResult && (
